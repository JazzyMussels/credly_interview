...
class Character < ApplicationRecord
    ...
    def self.assign_new_badge(character_id, badge_id)
        ...
        response_body = {
          ...
          RestClient::Request.execute(method: :post, url: "https://sandbox-api.credly.com/v1/organizations/#{ENV['CREDLY_ORG_ID']}/badges", payload: response_body, headers: credly_headers)
